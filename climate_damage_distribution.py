...
def calculate_climate_damage_and_gini_effect(delta_T, Gini_current, y_mean, params):
    ...
    params : dict
        ...
        - 'fract_gdp': fraction of GDP available for redistribution (optional, default 0)
          When fract_gdp >= 1, triggers uniform damage approximation
    ...
    **Special cases:**
    ...
    - fract_gdp >= 1: structural redistribution beyond Pareto family, uniform damage approximation
    ...
    **Computational advantages:**
    ...
    # When fract_gdp >= 1, structural redistribution invalidates Pareto distribution assumption
    if y_damage_halfsat > INVERSE_EPSILON or fract_gdp >= 1:
